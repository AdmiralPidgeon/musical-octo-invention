...
(function() {
  var changeHandler, data, div, entry, i, link, lockScreen, loggedIn, pwHash, showState, state,
  ...
  window.onkeyup = function(event) {
    ...
    if (loggedIn) {
      if ((ref = event.code) === 'KeyA' || ref === 'ArrowLeft') {
        replaceInnerHTML($('body'), state(data[modulo(--i, 50)]));
      }
      if ((ref1 = event.code) === 'KeyD' || ref1 === 'ArrowRight') {
        return replaceInnerHTML($('body'), state(data[modulo(++i, 50)]));
      }
    }
  };
