...
(function() {
  //###############################################################################
  var audio, audioCtx, blink, blinkOff, blinkOn, blinkputHandler, div, input, light, mode, morseChars, pwHash, randomizer, runBlink, runLockScreen, span;
...
0 -----`;
  ...
  blinkputHandler = function() {
    ...
    if (text !== 'soundOn' && text !== 'soundOff' && text !== 'randomOn' && text !== 'randomOff' && text !== 'knockMode' && text !== 'morseMode') {
      if (mode === 'knock') {
        knock(text);
      }
      if (mode === 'morse') {
